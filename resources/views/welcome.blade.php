...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand" href="index.html">MR_moon</a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
          <a class="nav-link" href="{{route('allDataShow')}}">All Data</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('show')}}">all Post</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{{url('insert')}}">Insert Data</a>
          </li>
          <li class="nav-item">
            <form class="nav-link" action="{{url('search')}}" method="GET">
                @csrf
